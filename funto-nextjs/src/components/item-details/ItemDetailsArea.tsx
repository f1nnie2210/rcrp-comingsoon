        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-body p-4 text-center">
              ...
              <div className="d-flex align-items-center justify-content-center"><a className="mx-2" href="#"><img src="/assets/img/core-img/icons8-facebook.svg" alt="" /></a><a className="mx-2" href="#"><img src="/assets/img/core-img/icons8-twitter.svg" alt="" /></a><a className="mx-2" href="#"><img src="/assets/img/core-img/icons8-instagram.svg" alt="" /></a><a className="mx-2" href="#"><img src="/assets/img/core-img/icons8-slack.svg" alt="" /></a><a className="mx-2" href="#"><img src="/assets/img/core-img/icons8-player.svg" alt="" /></a></div>
        ...
        <div className="container">
          <div className="row g-4 g-lg-5 justify-content-center">
            <div className="col-12 col-md-12 col-lg-6">
              <div className="item-big-thumb"><img src="/assets/img/bg-img/4.jpg" alt="" data-action="zoom" /></div>
            </div>
            ...
            <div className="col-12 col-md-9 col-lg-6">
              <div className="item-details-content mt-5 mt-lg-0">
                ...
                <div className="d-flex align-items-center mb-4">
                  <div className="author-img position-relative me-3"><img className="shadow" src="/assets/img/bg-img/u3.jpg" alt="" /><i className="bi bi-check position-absolute bg-primary"></i></div>
                ...
                <div className="row align-items-end">
                  ...
                  <div className="col-6 col-sm-4 col-lg-5"><a className="btn btn-primary rounded-pill w-100" href="#"><img className="me-1" src="/assets/img/core-img/fire.png" alt="" />Place a bid</a></div>
                </div>
          ...
          <div className="row">
            <div className="col-12">
              <div className="tab--area bg-gray p-4 p-lg-5">               
                ...
                <ul className="nav nav-tabs" id="RC:RPTab" role="tablist">
                  ...
                  <div className="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab--2">
                    <div className="table-responsive border shadow-sm activity-table item_table">
                      <table className="table mb-0">
                        <tbody>
                          <tr>
                            <th scope="row"><Link className="btn btn-minimal text-dark hover-primary" href="/item-details"> <img className="rounded me-1" src="/assets/img/bg-img/5.jpg" alt="" />NFT Logo</Link></th>
                            <td> <span className="d-inline-block fw-bold fz-14">0.235 ETH</span></td>
                            <td><Link className="btn btn-minimal text-dark hover-primary" href="/author"><img className="rounded-pill me-1" src="/assets/img/bg-img/u1.jpg" alt="" />@creative_art</Link></td>
                            <td><i className="bi bi-cart"></i>Sales</td>
                            <td><i className="bi bi-clock"></i>29 min ago</td>
                          </tr>
                          <tr>
                            <th scope="row"><Link className="btn btn-minimal text-dark hover-primary" href="/item-details"> <img className="rounded me-1" src="/assets/img/bg-img/6.jpg" alt="" />Pixel Art</Link></th>
                            <td> <span className="d-inline-block fw-bold fz-14">0.706 ETH</span></td>
                            <td><Link className="btn btn-minimal text-dark hover-primary" href="/author"><img className="rounded-pill me-1" src="/assets/img/bg-img/u2.jpg" alt="" />@designing_world</Link></td>
                            <td><i className="bi bi-percent"></i>Offer</td>
                            <td><i className="bi bi-clock"></i>1h ago</td>
                          </tr>
                          <tr>
                            <th scope="row"><Link className="btn btn-minimal text-dark hover-primary" href="/item-details"> <img className="rounded me-1" src="/assets/img/bg-img/7.jpg" alt="" />Funny Pigs</Link></th>
                            <td> <span className="d-inline-block fw-bold fz-14">0.105 ETH</span></td>
                            <td><Link className="btn btn-minimal text-dark hover-primary" href="/author"><img className="rounded-pill me-1" src="/assets/img/bg-img/u3.jpg" alt="" />@art_world</Link></td>
                            <td><i className="bi bi-patch-exclamation"></i>Alert</td>
                            <td><i className="bi bi-clock"></i>2h ago</td>
                          </tr>
                          <tr>
                            <th scope="row"><Link className="btn btn-minimal text-dark hover-primary" href="/item-details"> <img className="rounded me-1" src="/assets/img/bg-img/8.jpg" alt="" />Fancy Car 2</Link></th>
                            <td> <span className="d-inline-block fw-bold fz-14">0.95 ETH</span></td>
                            <td><Link className="btn btn-minimal text-dark hover-primary" href="/author"><img className="rounded-pill me-1" src="/assets/img/bg-img/u4.jpg" alt="" />@fancy_car</Link></td>
                            <td><i className="bi bi-cart"></i>Sales</td>
