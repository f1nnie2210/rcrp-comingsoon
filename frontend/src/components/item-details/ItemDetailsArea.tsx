...
const ItemDetailsArea = () => {
  ...
  return (
    <>
      <div
        className="share-modal modal fade"
        id="shareModal"
        tabIndex={-1}
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-body p-4 text-center">
              <h4 className="mb-4" id="shareModalLabel">
                Share this item
              </h4>
              ...
              <button
                className="btn btn-danger btn-sm rounded-pill mt-4"
                type="button"
      ...
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-body p-4 text-center">
              <h4 className="mb-4" id="copylinkLabel">
                Copy item link
              </h4>
      ...
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-body p-4 text-center">
              <h4 className="mb-4" id="reportModalLabel">
          ...
          <div className="row g-4 g-lg-5 justify-content-center">
            <div className="col-12 col-md-12 col-lg-6">
              <div className="item-big-thumb">
                <img src="/assets/img/bg-img/4.jpg" alt="" data-action="zoom" />
              </div>
            </div>
            ...
            <div className="col-12 col-md-9 col-lg-6">
              <div className="item-details-content mt-5 mt-lg-0">
                <div className="dropdown item-details-dd">
                  ...
                  >
                    ...
                    <li>
                      ...
                      >
                        <i className="me-1 bi bi-box-arrow-up-right"></i>Copy
                        Link
                      </a>
                    </li>
                    <li>
                ...
                <div className="d-flex flex-wrap align-items-center">
                  <button
                    className="btn btn-dark btn-sm rounded-pill px-3 wishlist-btn"
                    type="button"
                  >
                    <i className="bi"></i>
                    <span className="ms-1">98</span>
                  </button>

                  <div className="badge border px-3 py-2 rounded-pill text-dark fz-14 d-inline-block ms-1 ms-sm-4">
                    <i className="me-1 bi bi-eye"></i>8,634 people views this
                  </div>
                </div>
                ...
                <div className="row align-items-end">
                  ...
                  <div className="col-6 col-sm-4 col-lg-5">
                    <a className="btn btn-primary rounded-pill w-100" href="#">
                      <img
                        className="me-1"
                ...
                <div className="short-description">
                  ...
                  <p className="mb-0">
                    ...
                    numquam reprehenderit hic at, excepturi repudiandae magni
              ...
              <div className="tab--area bg-gray p-4 p-lg-5">
                <ul className="nav nav-tabs" id="RC:RPTab" role="tablist">
                  <li className="nav-item">
                    <a
                      className="nav-link rounded-pill bg-gradient active"
                      id="tab--1"
                      data-bs-toggle="tab"
                      href="#tab1"
                      role="tab"
                  ...
                  <li className="nav-item">
                    <a
                      className="nav-link rounded-pill bg-gradient"
                      id="tab--2"
                      data-bs-toggle="tab"
                      href="#tab2"
                      role="tab"
                    ...
                    <div className="card border-0">
                      ...
                      >
                        <p>
                          ...
                          elit. Dolor modi ut, debitis delectus deserunt ipsa
                          ullam necessitatibus expedita laboriosam mollitia
                          veniam rerum error iste, tempora vitae. Quasi totam
                          exercitationem odit.
                        </p>
                        <p>
                          Lorem, ipsum dolor sit amet consectetur adipisicing
                          elit. Accusamus quisquam consectetur aliquid
                          accusantium aut. A, veritatis voluptates. Blanditiis
                          ut repellat, reprehenderit rem ab cum cumque veniam
                          nulla officiis, quo maxime facilis aut eius labore
                          quisquam nemo ea illum! Reprehenderit officia illo
                          ipsa.
                        </p>
                        <ul>
                          <li>Bootstrap 5</li>
                        ...
                        <p className="mb-0">
                          Lorem ipsum dolor sit, amet consectetur adipisicing
                          elit. Beatae saepe eveniet optio minima, minus quas
                          distinctio iste laudantium in voluptates, corporis
                          labore. Debitis saepe et laudantium, dolor
                          necessitatibus eius porro reiciendis?
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <table className="table mb-0">
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <i className="bi bi-clock"></i>29 min ago
                            </td>
                          </tr>
                          <tr>
                            <th scope="row">
                            ...
                            <td>
                              <i className="bi bi-percent"></i>Offer
                            </td>
                            <td>
                              <i className="bi bi-clock"></i>1h ago
                            </td>
                          </tr>
                          <tr>
                            <th scope="row">
                            ...
                            <td>
                              <i className="bi bi-patch-exclamation"></i>Alert
                            </td>
                            <td>
                              <i className="bi bi-clock"></i>2h ago
                            </td>
                          </tr>
                          <tr>
                            <th scope="row">
                            ...
                            <td>
                              <i className="bi bi-clock"></i>3h ago
                            </td>
                          </tr>
                        </tbody>
                      </table>
