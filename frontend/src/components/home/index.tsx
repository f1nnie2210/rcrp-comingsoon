...
const ComingSoon = () => {
  return (
    <>
      <div
        className="coming-soon-wrapper bg-img bg-overlay"
            ...
            <div className="row justify-content-center">
              <div className="col-12 col-lg-8">
                <div className="logo mb-5">
                  <img src="/assets/img/core-img/logo-white.png" alt="" />
                </div>
                ...
                <p className="mb-4">
                Trở thành bất cứ ai bạn muốn cùng RC:RP.
                </p>
                <Link className="btn btn-primary btn-sm rounded-pill" href="https://dsc.gg/rcrpvn">
