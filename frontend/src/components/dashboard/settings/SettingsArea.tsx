            ...
            <div className="col-12 col-lg-10 col-xl-9 col-xxl-8">
              <ul className="nav nav-tabs border-0 mb-3" role="tablist">
                <li className="nav-item">
                  <a
                    className="position-relative nav-link mb-0 rounded-pill border-0 me-1 active"
                    id="tab--1"
                    data-bs-toggle="tab"
                    href="#tab1"
                    role="tab"
                ...
                <li className="nav-item">
                  <a
                    className="nav-link mb-0 rounded-pill border-0 me-1"
                    id="tab--2"
                    data-bs-toggle="tab"
                    href="#tab2"
                    role="tab"
                        ...
                        <div className="row g-4">
                          ...
                          <div className="col-12">
                            <button
                              ...
                              type="submit"
                            >
                              <i className="bi bi-sd-card-fill me-1"></i>Save
                              changes
                            </button>
                          </div>
                        </div>
