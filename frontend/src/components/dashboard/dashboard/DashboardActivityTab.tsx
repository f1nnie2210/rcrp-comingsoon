          ...
          <div className="card-body p-4">
            <div className="d-flex flex-wrap align-items-center justify-content-between mb-3">
              ...
              <nav>
                ...
                >
                  <button
                    className="nav-link rounded-pill mb-0 px-3 py-1 border-0 shadow-sm me-1 active"
                    id="nav-home-tab"
                    data-bs-toggle="tab"
                  ...
                  <button
                    className="nav-link rounded-pill mb-0 px-3 py-1 border-0 shadow-sm me-1"
                    id="nav-profile-tab"
                    data-bs-toggle="tab"
                  ...
                  <table className="table mb-0">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <i className="bi bi-clock"></i>12h ago
                        </td>
                      </tr>
                      <tr>
                        <th scope="row">
                        ...
                        <td>
                          <i className="bi bi-clock"></i>17h ago
                        </td>
                      </tr>
                    </tbody>
                  </table>
