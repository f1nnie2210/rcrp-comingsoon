...
const categories = [
  'All',
  ...new Set(discover_data.map((item) => item.catagory)),
]
const perView = 12
              ...
              <div className="filters-button-group d-flex justify-content-md-end flex-wrap">
                {categories.map((cate, i) => (
                  <React.Fragment key={i}>
                    ...
                    >
                      {cate === 'art' && (
                        <i className="fz-16 bi bi-palette me-2" />
                      )}
                      {cate === 'cards' && (
                        <i className="fz-16 bi bi-card-image me-2" />
                      )}
                      {cate === 'collectibles' && (
                        <i className="fz-16 bi bi-list-stars me-2" />
                      )}
                      {cate === 'photos' && (
                        <i className="fz-16 bi bi-image me-2" />
                      )}
                      {cate === 'All' && (
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <div className="row g-4 RC:RP-collection-filter-list">
                {items.slice(0, next).map((item, index) => (
                  <div
                    key={index}
                    className="col-12 col-sm-6 col-lg-4 col-xl-3 list-item cards"
                  >
                      ...
                      <div className="card-body">
                        <div className="img-wrap">
                          ...
                          <div className="badge bg-primary position-absolute">
                            <img src="/assets/img/core-img/fire.png" alt="" />
                            Featured
                          </div>
                        ...
                        <div className="row gx-2 align-items-center mt-3">
                          <div className="col-8">
                            ...
                            >
                              <i
                                className={`bi ${item.topLevelInfo[0].icon}`}
                              />
