                ...
                <div className="col-12 col-sm-8 col-lg-9">
                  <div className="author-data">
                    <h3 className="mb-2 author-name text-white">
                      Designing World
                      <a
                        className="btn btn-warning btn-sm rounded-pill align-top ms-2 px-3 py-1"
                        href="#"
                      >
                        Follow
                      </a>
                    </h3>
                    <div className="btn btn-minimal d-inline-block mb-3 text-white hover-warning">
                      @designing_world
                    </div>
                    <p className="w-75 mb-0" style={{ color: '#8084AE' }}>
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                      Rerum quaerat quis similique natus rem.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-12 col-sm-9 col-lg-4">
              <div className="card author-sidebar-card shadow-sm">
                <div className="card-body p-4 p-md-5 p-lg-4 p-xl-5">
                  ...
                  <p style={{ color: '#8084AE' }}>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Suscipit architecto ipsum quas, eum eius sint esse, omnis
                    quis voluptas est dicta earum dolore recusandae autem
                    asperiores, sed non. Maxime, eius!
                  </p>
                  <div className="meta-data d-flex align-items-center mt-4">
                    ...
                    <h6 className="mb-0 border-end text-center pe-3 me-3">
                      <span className="counter">861 </span>
                      <br /> Owners
                    </h6>
                    <h6 className="mb-0 text-center">
                      <span className="counter">3510 </span>
                      <br /> Followers
                    </h6>
                  </div>
                </div>
